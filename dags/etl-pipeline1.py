...
from airflow.operators.bash import BashOperator # trabalhar com o terminal
from airflow.operators.email_operator import EmailOperator # trabalhar com envio de emails
from airflow.operators.python import PythonOperator 
import pandas as pd
import sqlalchemy # biblioteca para lidar com comandso sql

path_temp_csv = "/tmp/dataset.csv"
email_failed = "jonascesconetto@gmail.com"
...
def _extract():
  ...
  engine_mysql_oltp = sqlalchemy.create_engine('mysql+pymysql://root:airflow@172.17.0.4:3306/employees')
